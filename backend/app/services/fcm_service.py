...
async def send_push(fcm_token: str, title: str, body: str, data: Dict[str, Any] = {}) -> bool:
    """
...
async def send_push_bulk(tokens: list, title: str, body: str, data: Dict[str, Any] = {}) -> tuple[int, int]:
    """
...
async def send_fund_allocated_notification(user_fcm_token: str, complaint_id: str, amount: float) -> bool:
    ...
    return await send_push(
        ...
        body=f"Rs. {amount:,.0f} has been allocated for your report {complaint_id}.",
        data={
            "complaint_id": complaint_id,
            "screen": "complaint_detail",
            "type": "funded"
...
async def send_emergency_alert(fcm_token: str, complaint_id: str):
    ...
    return await send_push(
        ...
        body="Severe road damage reported nearby. Drive carefully.",
        data={
            "complaint_id": complaint_id,
            "screen": "map",
            "priority": "high",
