...
# --- Counters ---
COMPLAINTS_SUBMITTED_TOTAL = Counter(
    "complaints_submitted_total",
...
AI_INFERENCE_DURATION_SECONDS = Histogram(
    ...
    "Time spent running YOLOv8 inference",
    ["damage_type"],
    buckets=(0.1, 0.5, 1.0, 2.0, 5.0, 10.0, float("inf"))
)

COMPLAINT_SUBMISSION_DURATION_SECONDS = Histogram(
    "complaint_submission_duration_seconds",
    "End-to-end duration of the submission API call (request-response)",
...
ACTIVE_WEBSOCKET_CONNECTIONS = Gauge(
    ...
    "Current number of active WebSocket connections for live status updates"
)
